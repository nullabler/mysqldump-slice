...
func (db *DbMockWrapper) LoadIds(key string, s *config.Specs, l []string) ([]entity.ValList, error) {
...
func (db *DbMockWrapper) LoadPkByCol(string, string, []string, []string, bool) ([]entity.ValList, error) {
